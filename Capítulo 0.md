...
Para este tutorial, basta possuir um PC com os sistemas Windows ou Linux. O compilador que utilizarei será o GCC. Não utilizarei nenhuma IDE (exemplos: Visual Studio, Code::Blocks, Dev-C++) pois o foco deste tutorial é ensinar a linguagem, a desenvolver o código.
